...
export function UnitedKingdomFlag(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <defs>
        <path id="flagpackGbNir0" fill="#fff" d="M0 0h32v24H0z"></path>
      </defs>
      <g fill="none">
        <g clipPath="url(#flagpackGbNir3)">
          <use href="#flagpackGbNir0"></use>
          <path
            fill="#2E42A5"
            fillRule="evenodd"
            d="M0 0v24h32V0H0Z"
          ...
          <g mask="url(#flagpackGbNir1)">
            ...
            ></path>
            <mask id="flagpackGbNir2" fill="#fff">
              <path
                fillRule="evenodd"
